...
jest.mock('./path-to-getCountries', function () { return ({
    getCountries: jest.fn(function () {
...
describe('onLoad function', function () {
    ...
    it('should populate countrySelect with options', function () { return __awaiter(void 0, void 0, void 0, function () {
        var options, value, textContent;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, onLoad()];
                case 1:
                    _a.sent();
                    options = document.querySelectorAll('#countrySelect option');
                    value = options[0].getAttribute('value');
                    textContent = options[0].getAttribute('textContent');
